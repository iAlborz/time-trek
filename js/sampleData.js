// sampleData.js — Shared demo dataset, used by the timeline's "Load Sample Data"
// and the projects page's "Open/Download Sample Project" actions.

export const SAMPLE_CSV = `Item Name,Type,Start Date,End Date,Parent Item,Notes
